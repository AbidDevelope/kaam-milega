...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="connect-page"><img src="public/assets-new/images/navbar/user.png" alt=""></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="connect-page-single-events"><img src="public/assets-new/images/navbar/bookmark.png" alt=""></a>
                        </li>
                        <li class="nav-item">
    ...
    <!-- -----------Navbar End Here------------ -->
    <!-- --------------connect-page-single-events-parent-sec start------------------ -->
    <section class="connect-page-single-events-parent-sec">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-12">
                    <div class="single-event-details-dv-parent">
                        <div class="img-section-parent">
                            <img src="public/assets-new/images/connect-page/event-details.png" alt="">
                            <h3 class="img-heading">LinkedIn Lead Generation Strategies & System to 2-10X Your Sales in
                                2023</h3>

                            <p class="event-name">Event by <span>Company Name</span></p>
                            <p class="details-p-lists"><img src="public/assets-new/images/connect-page/calender.png" alt=""> Thu,
                                Oct 12, 2023, 8:30 PM - 9:30 PM (your local time)</p>
                            <p class="details-p-lists"><img src="public/assets-new/images/connect-page/online.png" alt=""> Online
                            </p>
                            <p class="details-p-lists"><img src="public/assets-new/images/connect-page/connections.png" alt="">
                                <img src="public/assets-new/images/connect-page/details-profile.png" alt=""> Vinay Juneja and
                                23,374 other attendees</p>
                            <div class="register-share-button">
                                <div class="register-btn">
                                    <a href="#">Register</a>
                                </div>
                                <div class="share-btn">
                                    <a href="#"><img src="public/assets-new/images/connect-page/share.png" alt=""> Share</a>
                                </div>
                            </div>
                        </div>
                        <div class="about-section-tabs-parent">
                            <!-- ================================================================== -->
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="contact-person-card-dv">
                                        ...
                                        <div class="contact-person-name">
                                            <p>Lorem ipsum dolor sit amet consectetur. Posuere phasellus tortor dictum viverra sit et elementum donec. Ac sed rutrum pellentesque posuere in iaculis bibendum egestas. Ultricies id arcu mi mauris eu aliquam. A enim aliquam mollis aliquet suspendisse turpis vitae leo. Sodales imperdiet volutpat et nunc pretium vel vulputate egestas elit. Ac interdum et sem platea.</p>
                                        </div>
                                    </div>
                                    <!-- --------------card listing end---------- -->
                                </div>
                        ...
                        <div class="speaker-section-last-dv">
                            <div class="contact-person-card-dv">
                                <div class="contact-h-heading">
                                    <h4>Speakers</h4>
                                </div>
                                            ...
                                            <div class="right-dv-second-inner">
                                                <div class="img-name-digination-location-dv">
                                                    <div class="name-img-left">
                                                        ...
                                                        " alt="">
                                                        <div class="active-green-dot"></div>
                                                    </div>
    ...
    <!-- --------------connect-page-single-events-parent-sec end------------------ -->
