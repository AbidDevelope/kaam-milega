            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#"><img src="public/assets-new/images/navbar/home.png" alt=""></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="connect-page"><img src="public/assets-new/images/navbar/user.png" alt=""></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('jobs') }}"><img src="public/assets-new/images/navbar/suitcase.png" alt=""></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a href="{{ url('user-profile') }}" class="nav-link dropdown-toggle ps-0">
                            <img src="public/assets-new/images/navbar/Profile.png"
                                    class="border rounded-circle" alt=""> {{auth()->user()->name}}
                            </a>
                            <!-- <a class="nav-link dropdown-toggle ps-0 " href="{{ url('home-page-after-login') }}" role="button"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="right-side-job-listing-parent">
                            ...
                            <div class="show-alertwith-location-find">
                                <p>Accountant in bangalore, India</p>
                                <div class="form-check form-switch">
                                    <label class="form-check-label" for="flexSwitchCheckChecked">Alert On</label>
                            ...
                            <div class="top-match-card-parent">
                                <div class="top-match-chat-btn-parent">
                                    ...
                                    <div class="chat-with-hr-apply-now">
                                        ...
                                        <a href="job-listing-details-page-before-login" class="apply-now-a">Apply
                                            Now</a>
                                    </div>
                                </div>
                                <div class="post-name-and-company-title">
                                    <h4><a href="job-listing-details-page-after-login">Accountant Cum Office Assistant</a></h4>
