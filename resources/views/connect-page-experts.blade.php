...
<body>
    ...
    <!-- -----------Navbar End Here------------ -->
    <!-- --------------connect-page-experts-parent-sec start------------------ -->
    <section class="connect-page-experts-parent-sec">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="connect-page-connection-9parent">
                        <div class="connect-page-connection-inner ">
                            <div class="a-tag-become-expert">
                                <a href="#">Become A Expert</a>
                            </div>
                            <div class="connection-heading ">
                                <h4>
                                    <a href="connect-page">
                                        <img src="public/assets-new/images/connect-page/back-icon.png" alt="">
                                    </a> 20 Experts
                                </h4>
                            ...
                            <div class="person-name-designation-parent">
                                <div class="person-designation-left">
                                    <img src="public/assets-new/images/connect-page/cir-img.png" alt="">
                                    <div class="right-heading-name-design">
                                        <h5>Expert Name</h5>
                                        <p>Expert Designation</p>
                                        <p>10 Mutual Connects</p>
                                    </div>
                                </div>
                                <div class="chat-del-icon-right">
                                    <div class="chat-icon">
                                        <a href="#" class="d-flex align-items-center"><img src="public/assets-new/images/connect-page/chat.png" alt=""> Chat</a>
                                    </div>
                                    <div class="del-icon">
                                        <a href="#" class="d-flex align-items-center"><img src="public/assets-new/images/connect-page/del-icon.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- --------------card listing end---------- -->
    ...
    <!-- --------------connect-page-experts-parent-sec end------------------ -->
