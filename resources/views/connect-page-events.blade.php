...
<body>
    ...
    <!-- -----------Navbar End Here------------ -->
    <!-- --------------connect-page-events-parent-sec start------------------ -->
    <section class="connect-page-events-parent-sec">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="connect-page-connection-inner">
                            ...
                            <div class="person-name-designation-parent">
                                <div class="person-designation-left">
                                    <img src="public/assets-new/images/connect-page/events-thumb-small.png" alt="">
                                    <div class="right-heading-name-design">
                                        <h5> <a href="connect-page-single-events">Lorem ipsum Event name</a></h5>
                                        <p>Event by <span>Company Name</span></p>
                                        <div class="date-time-state-parent">
                                            <p><img src="public/assets-new/images/connect-page/calender.png" alt=""> <span>Thu, Oct 12, 2023, 8:30 PM - 9:30 PM (your local time)</span></p>
                                            <p><img src="public/assets-new/images/connect-page/online.png" alt=""> <span>Online</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="chat-del-icon-right">
                                    <div class="del-icon">
                                        <a href="#" class="d-flex align-items-center"><img src="public/assets-new/images/connect-page/calender-cir.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!-- --------------card listing end---------- -->
    ...
    <!-- --------------connect-page-events-parent-sec end------------------ -->
