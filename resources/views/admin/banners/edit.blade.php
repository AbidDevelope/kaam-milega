        ...
        <form role="form" method="post" action="{{ url($base_url.'/'.$id) }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="exampleInputFile"> Job Seeker Banner</label>
                ...
                <div>
                    <img src="{{ asset('public/uploads/'.$rec_image) }}" class="imgThumb">
                </div>
                <div class="form-group">
                    <label for="exampleInputFile"> Recruiter Banner</label>
