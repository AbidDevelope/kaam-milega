            ...
            <form role="form" method="post" action="{{ url($base_url.'/'.$id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('exam_notes_descriptions') is-invalid @enderror" value="" id="editor"
                        name="exam_notes_descriptions" placeholder="Enter exam_notes_descriptions">{{ $exam_notes_descriptions }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('help_descriptions') is-invalid @enderror" value="" id="editor1"
                        name="help_descriptions" placeholder="Enter help_descriptions">{{ $help_descriptions }}</textarea>
