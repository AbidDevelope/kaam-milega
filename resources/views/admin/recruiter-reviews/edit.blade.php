    ...
    <form role="form" method="post" action="{{ url($base_url.'/'.$id) }}" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $name }}" id="name"
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('company_name') is-invalid @enderror"
            value="{{ $company_name }}" id="company_name" name="company_name" placeholder="Enter company_name">
          @error('company_name')
          <div class="text-danger" role="alert">{{ $message }}</div>
          @enderror
        </div>
        <div class="form-group">
          ...
          <textarea class="form-control @error('comment') is-invalid @enderror" value="" id="editor" name="comment"
            placeholder="Enter comment">{{ $comment }}</textarea>
          @error('comment')
          <div class="text-danger" role="alert">{{ $message }}</div>
          @enderror
        </div>
