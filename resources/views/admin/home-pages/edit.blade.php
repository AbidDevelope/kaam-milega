        ...
        <form role="form" method="post" action="{{ url($base_url.'/'.$id) }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="name">Portal Tutorial Video Url</label>
                    <input type="url" class="form-control @error('tutorial_video') is-invalid @enderror" value="{{ $tutorial_video }}"
                        id="tutorial_video" name="tutorial_video" placeholder="Enter tutorial_video url">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('about_data') is-invalid @enderror" value="" id="editor"
                        name="about_data" placeholder="Enter about_data">{{ $about_data }}</textarea>
                    @error('about_data')
                        <div class="text-danger" role="alert">{{ $message }}</div>
                    @enderror
                </div>
