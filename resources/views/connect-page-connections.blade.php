...
<body>
    ...
    <!-- -----------Navbar End Here------------ -->
    <!-- --------------connect-page-connections-parent-sec start------------------ -->
    <section class="connect-page-connections-parent-sec">
        <div class="container-fluid">
            <div class="row">
    ...
    <!-- --------------connect-page-connections-parent-sec end------------------ -->
