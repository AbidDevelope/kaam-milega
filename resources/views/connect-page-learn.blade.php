...
<body>
    ...
    <!-- -----------Navbar End Here------------ -->
    <!-- --------------connect-page-learn-parent-sec start------------------ -->
    <section class="connect-page-learn-parent-sec">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="connect-page-connection-inner">
                            ...
                            <div class="person-name-designation-parent">
                                <div class="person-designation-left">
                                    <img src="public/assets-new/images/connect-page/learn-list.png" alt="">
    ...
    <!-- --------------connect-page-learn-parent-sec end------------------ -->
